...
{
    public class UserCrudComplet : BaseTest, IClassFixture<DbTest>
    {
       private ServiceProvider _serviceProvider; 

       public UserCrudComplet(DbTest dbTest)
       {
        ...
        public async Task E_Possivel_Realizar_CRUD_Usuario()
        {
            using (var context = _serviceProvider.GetService<MyContext>())
            {
                ...
                // var _usuarioPadrao = await _repositorio.FindByLogin("teste1@gmail.com");
